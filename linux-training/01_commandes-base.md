...
Toutes ces commandes sont expliquées dans ce guide sur [les commandes de
...
Fichier utilisé : `exercices/fichier_exercice1.txt`
...
Fichier utilisé : `exercices/fichier_exercice2.txt`
...
Fichier utilisé : `exercices/fichier_exercice3.txt`

1. Copiez `fichier_exercice3.txt` vers un nouveau fichier `copie.txt` :

```bash
cp exercices/fichier_exercice3.txt copie.txt
```
...
Fichier utilisé : `exercices/fichier_exercice4.txt`

1. Affichez les 5 premières lignes du fichier :

```bash
head -n 5 exercices/fichier_exercice4.txt
```

2. Affichez les 3 dernières lignes du fichier :

```bash
tail -n 3 exercices/fichier_exercice4.txt
```

3. Affichez l’intégralité du fichier avec pagination :

```bash
less exercices/fichier_exercice4.txt
```
...
Fichier utilisé : `exercices/fichier_exercice5.txt`

1. Donnez les droits d’exécution au fichier :

```bash
chmod +x exercices/fichier_exercice5.txt
```

2. Changez le propriétaire du fichier (nécessite sudo) :

```bash
sudo chown $USER exercices/fichier_exercice5.txt
```
